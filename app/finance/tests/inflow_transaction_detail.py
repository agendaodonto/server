...
class InflowTransactionDetailAPITest(APITestCase):
    ...
    def test_should_update_inflow_transaction(self):
        ...
        url = reverse('inflow-transaction-detail', kwargs={'clinic_id': self.clinic.id, 'pk': avail_transaction.id})
        ...
        self.assertEqual(self.serializer.to_representation(avail_transaction), new_data)
    ...
    def test_should_delete_inflow_transaction(self):
        ...
        self.assertEqual(InflowTransaction.objects.count(), 0)
    ...
    def test_should_not_allow_update_transaction_from_a_non_owned_clinic(self):
        ...
        url = reverse('inflow-transaction-detail', kwargs={
        ...
        # Assert
        refreshed_model = InflowTransaction.objects.get(pk=other_clinic_transaction.pk)
    ...
    def test_should_not_allow_delete_transaction_from_a_non_owned_clinic(self):
        ...
        # Assert
        self.assertEqual(req.status_code, 404)
        self.assertEqual(InflowTransaction.objects.count(), 1)
